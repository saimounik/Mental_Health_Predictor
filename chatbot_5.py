...
grade_messages = {
    ...
    3: "Level 3: Moderate risk. Try to focus on improving your mental and physical health.",
...
st.write("This chatbot predicts mental health levels based on your inputs. Simply provide the required details below.")

# Sidebar for contact information
st.sidebar.markdown(
    """
    **Mental Health Status Predictor by:**
    
    Sai Mounik Kamisetty  
    kamisettys@mail.sacredheart.edu  
    BUAN-690  
...
if st.button("Predict"):
    ...
    # Display the level and message
    st.success(f"Predicted Mental Health Status Level: {predicted_grade}")
    st.info(grade_messages.get(predicted_grade, "No message available for this level."))
